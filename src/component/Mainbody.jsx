...
let changpage=(el)=>{
  ...
  return (
    <div id='maincantainer'>
      <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"20px", marginTop:"50px",marginBottom:"30px"}}>
        {
          product?.map(el=><Carts key={el.id} names={el.name} colorId={el.colorId} image={el.image} materialId={el.materialId} price={el.price}  id={el.id}/>)
